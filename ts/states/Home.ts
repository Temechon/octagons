module OCT {
    ...
    export class Home extends Phaser.State {
        ...
        create() {
            ...
            let style = { font: Helpers.font(40, 'KeepCalm'), fill: "#BABABA", align: "center" };
            let levelsDone = this.game.add.text(this.game.width / 2, hardestbutton.y + hardestbutton.height / 2 + 150 * ratio, "Levels done", style);
